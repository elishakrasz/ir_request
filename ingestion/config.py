...
class Config:
    ...
    # OFF by default (dropped 2026-09-15: every email opens its own ticket; the
    # team would rather see and dismiss than have anything folded away).
    ...
    def from_env(cls, env: dict | None = None):
        ...
        return cls(
            ...
            merge_requests=env.get("MERGE_REQUESTS", "0") == "1",
